...
public class S3Writer {
	public static final TimeZone UTC = TimeZone.getTimeZone("UTC"); //RBP
	...
	public void putChunk(String localDataFile, TopicPartition tp) throws IOException {
	...
	private String getChunkFileKey(String localFilePath) {
		...
		df.setTimeZone(UTC);
		//pfx/2018-05-17/bar-00000-000000000000.gz
