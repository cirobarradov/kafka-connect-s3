...
public class BlockGZIPFileWriter implements Closeable {
	...
	private void initChunkWriter() throws IOException {
		//gzipStream = new GZIPOutputStream(fileStream);
		fileOutputStream = new FileOutputStream(getDataFilePath());
	}
	...
	public String getOutputFileName(){
		//20180201_1236_car2go_vehicles_madrid.json
		return String.format("%s-%012d.json", filenameBase, firstRecordOffset);
		//return String.format("%s/%s", path,String.format("%s-%012d.json", filenameBase, firstRecordOffset));
	}
	...
	public String getDataFilePath() {
		return String.format("%s/%s", path, this.getOutputFileName());
